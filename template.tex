% aspectratio = 43 or 169
\documentclass[aspectratio=169, compress]{beamer}
\usetheme{zuel}
\usepackage{pstricks-add,calligra}
% 中文字体设置（英文请注释掉下两行）
...
%------------------------------------------------
% 设置基本信息
\title[ZUEL Beamer Theme]
{毕业设计开题报告}
\author{Leon}
\institute{统计与数学学院\\中南财经政法大学}
\date[\today]{\today}
%------------------------------------------------
...
\begin{frame}{用Beamer很高大上？}
    \begin{itemize}[<+-| alert@+>] % 当然，除了alert，手动在里面插 \pause 也行
        ...
        \item 内容参考 THU Beamer Github项目地址位于 \url{https://github.com/tuna/THU-Beamer-Theme}
        \item 格式参考 Oxford Mathematical Institute Beamer Presentation Overleaf模板地址 \url{https://cn.overleaf.com/latex/templates/oxford-mathematical-institute-beamer-presentation/zxkbrjpszxjr}
    \end{itemize}
\end{frame}
%------------------------------------------------
